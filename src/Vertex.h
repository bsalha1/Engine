...
namespace Engine
{
    struct Vertex3d
    {
        ...
        static void setup_vertex_array_attribs(const VertexArray &vertex_array)
        {
            vertex_array.setup_vertex_attrib(0, &Vertex3d::position);
        }
    };
    ...
    struct TexturedVertex2d
    {
        ...
        static void setup_vertex_array_attribs(const VertexArray &vertex_array)
        {
            vertex_array.setup_vertex_attrib(0, &TexturedVertex2d::position);
            vertex_array.setup_vertex_attrib(1, &TexturedVertex2d::texture);
        }
    };
    ...
    struct TexturedVertex3dNormal
    {
        ...
        static void setup_vertex_array_attribs(const VertexArray &vertex_array)
        {
            vertex_array.setup_vertex_attrib(0, &TexturedVertex3dNormal::position);
            vertex_array.setup_vertex_attrib(1, &TexturedVertex3dNormal::norm);
            vertex_array.setup_vertex_attrib(2, &TexturedVertex3dNormal::texture);
        }
    };
