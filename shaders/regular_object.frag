...
void main()
{
    ...
    vec3 result = compute_directional_component(u_directional_light, normal, v_view_direction);
    result += compute_point_component(u_point_light, normal, v_position_world_coords, v_view_direction);
